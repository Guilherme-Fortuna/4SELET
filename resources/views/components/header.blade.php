<div id="border-header" class="border-bottom">
    <div name="Header section" id="header" class="container">
        <div class="row align-items-end py-3">
            ...
            <div name="Buttons header" class="col text-center header-buttons-center">
                <a href="#">Product</a>
                <a href="#">Services</a>
                <a href="#">Article</a>
                <a href="#">About Us</a>
