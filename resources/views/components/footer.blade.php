    ...
    <div class="py-6 grid grid-cols-2">
        ...
        <div class="grid grid-cols-3 place-self-end gap-x-12">
            <div class="flex flex-col gap-y-4">
                ...
                <a href="#"><p3>Best Selling</p3></a>
                <a href="#"><p3>Home Decor</p3></a>
                <a href="#"><p3>Kitchen Set</p3></a>
            </div>

            <div class="flex flex-col gap-y-4">
                <h4>Services</h4>
                <a href="#"><p3>Catalog</p3></a>
                <a href="#"><p3>Blog</p3></a>
                <a href="#"><p3>FaQ</p3></a>
                <a href="#"><p3>Pricing</p3></a>
            </div>
            <div class="flex flex-col gap-y-4">
                <h4>Follow Us</h4>
                <a href="#"><p3>Facebook</p3></a>
                <a href="#"><p3>Instagram</p3></a>
                <a href="#"><p3>Twitter</p3></a>
            </div>
        </div>
    </div>
</div>
